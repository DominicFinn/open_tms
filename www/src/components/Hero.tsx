...
const killerFeatures = [
  ...
  },
  {
    ...
    description: 'Planned routes per lane with automatic off-route detection and exception escalation.',
    link: '/features/operations',
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'Full warehouse flow: receiving, directed putaway, wave planning, picking, packing, cycle counting, and replenishment.',
    link: '/features/warehouse',
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5M10 11.25h4M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125z" />
  ...
  },
  {
    ...
    description: 'Full AR/AP lifecycle with three-way freight audit, auto-invoicing, and LTL rating.',
