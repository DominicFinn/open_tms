  ...
  return (
    <div className="gradient-bg min-h-screen">
      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden">
        ...
        {/* Mobile: show preview below hero text since background version is hidden */}
        <div className="lg:hidden px-4 pb-12">
          <AnimateIn animation="scale-up">
            <div className="rounded-2xl overflow-hidden border border-white/5 shadow-2xl shadow-primary-900/20">
              <OperationsPreview />
            </div>
            <p className="text-center text-surface-400 text-sm mt-4 italic">
              The Operations dashboard  - shipments, carriers, and status at a glance
            </p>
          </AnimateIn>
        </div>
      </section>
